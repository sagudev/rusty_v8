...
COMMIT=$( cat ./spidershim/etc/COMMIT )
echo "Commit $COMMIT"
...
curl -L --output ./spidershim/mozjs.tar.xz "https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/$task_id/runs/0/artifacts/$tar_file"